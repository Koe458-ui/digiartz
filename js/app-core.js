// supabase and s3 helpers, loaders
  ...
  function restoreScroll(){
    ...
    var locks=['fg','artModal','communityPage','adsPanel','legalBackdrop','subPage','profilePage','pfEditPage','pfMyWorkPage','authMod','notifPage','admPage','zeoPage','frdPage','cmInfoPage','bmPage','xpPage','setPage','rankPage','pfUpMod','albPage','albViewPage','tgMod','dzPanelHost','fgSearchPage'];
  ...
  var NAV_OVER=['setPage','dzPanelHost','subPage','pfEditPage','pfMyWorkPage',
                'notifPage','admPage','bmPage','frdPage','cmInfoPage','xpPage','rankPage','themePage',
                'albPage','albViewPage'];
  function dzNavSync(){
